...
[ -n "$PRIVATE_BOSH_LITE_OPS_FILE_NAME" ] && PRIVATE_BOSH_LITE_OPS_FILE="$CONFIGS_DIR/deployments/$DEPLOYMENT_NAME/$PRIVATE_BOSH_LITE_OPS_FILE_NAME.yml"
[ -n "$PRIVATE_BOSH_FULL_OPS_FILE_NAME" ] && PRIVATE_BOSH_FULL_OPS_FILE="$CONFIGS_DIR/deployments/$DEPLOYMENT_NAME/$PRIVATE_BOSH_FULL_OPS_FILE_NAME.yml"

# Publically available ops files, eg adjustments for VMware
[ -n "$PUBLIC_BOSH_LITE_OPS_FILE_NAME" ] && PUBLIC_BOSH_LITE_OPS_FILE="$MANIFESTS_DIR/Bosh-Lite-Manifests/$PRIVATE_BOSH_LITE_OPS_FILE_NAME.yml"
[ -n "$PUBLIC_BOSH_FULL_OPS_FILE_NAME" ] && PUBLIC_BOSH_FULL_OPS_FILE="$MANIFESTS_DIR/Bosh-Lite-Manifests/$PRIVATE_BOSH_FULL_OPS_FILE_NAME.yml"
