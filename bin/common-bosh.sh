...
BOSH_LITE_VARS_FILE="$DEPLOYMENT_DIR_RELATIVE/$BOSH_LITE_MANIFEST_NAME-Lite-vars.yml"
BOSH_PREAMBLE_VARS_FILE="$DEPLOYMENT_DIR_RELATIVE/$BOSH_PREAMBLE_MANIFEST_NAME-vars.yml"
BOSH_FULL_VARS_FILE="$DEPLOYMENT_DIR_RELATIVE/$BOSH_FULL_MANIFEST_NAME-Full-vars.yml"
