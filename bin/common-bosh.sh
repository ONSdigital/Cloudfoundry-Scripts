...
STACK_OUTPUTS_DIR_RELATIVE="$DEPLOYMENT_FOLDER_RELATIVE/$DEPLOYMENT_NAME/outputs"
...
load_outputs "$DEPLOYMENT_NAME" "$DEPLOYMENT_DIRECTORY_RELATIVE" "$STACK_OUTPUTS_DIR_RELATIVE" "$ENV_PREFIX"
