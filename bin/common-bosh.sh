...
BOSH_OPS_FILE_PREFIX='Bosh-ops'
BOSH_LITE_OPTS_FILE_SUFFIX="${BOSH_LITE_OPTS_FILE_SUFFIX:-NOOP}"
BOSH_FULL_OPTS_FILE_SUFFIX="${BOSH_FULL_OPTS_FILE_SUFFIX:-NOOP}"
...
BOSH_LITE_OPS_FILE="$MANIFESTS_DIR/Bosh-Lite-Manifests/$BOSH_OPS_FILE_PREFIX-$BOSH_LITE_OPTS_FILE_SUFFIX.yml"
...
BOSH_FULL_OPS_FILE="$MANIFESTS_DIR/Bosh-Lite-Manifests/$BOSH_OPS_FILE_PREFIX-$BOSH_FULL_OPTS_FILE_SUFFIX.yml"
...
[ -f "$BOSH_LITE_OPS_FILE" ] || FATAL "Bosh Lite Ops file '$BOSH_LITE_OPS_FILE' does not exist"
...
[ -f "$BOSH_FULL_OPS_FILE" ] || FATAL "Bosh Ops file '$BOSH_FULL_OPS_FILE' does not exist"
