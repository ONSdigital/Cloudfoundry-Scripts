...
if [ x"$availability" = x"MultiAZ" ]; then
	...
	BOSH_AVAILABILITY_VARIABLES_NAME="$BOSH_AVAILABILITY_VARIABILITY_PREFIX-HA"
else
	# Assume single AZ and no HA
	BOSH_FULL_MANIFEST_NAME="$BOSH_FULL_MANIFEST_PREFIX"
	BOSH_CLOUD_MANIFEST_NAME="$BOSH_CLOUD_MANIFEST_PREFIX"
	BOSH_CLOUD_AVAILABILITY_VARIABLES_NAME="$BOSH_AVAILABILITY_VARIABLES_PREFIX-$CPI_TYPE"
	BOSH_FULL_STATIC_IPS_NAME="$BOSH_STATIC_IPS_PREFIX"
	BOSH_AVAILABILITY_VARIABLES_NAME="$BOSH_AVAILABILITY_VARIABILITY_PREFIX"
fi
...
BOSH_FULL_CLOUD_CONFIG_FILE="$MANIFESTS_DIR_RELATIVE/Bosh-Full-Manifests/$BOSH_CLOUD_MANIFEST_NAME.yml"
BOSH_FULL_CLOUD_AVAILABILITY_FILE="$MANIFESTS_DIR_RELATIVE/Bosh-Full-Manifests/$BOSH_AVAILABILITY_VARIABLES_NAME.yml"
...
[ -f "$BOSH_FULL_CLOUD_AVAILABILITY_FILE" ] || FATAL "Bosh CPI specific variables file '$BOSH_FULL_CLOUD_AVAILABILITY_FILE' does not exist"
