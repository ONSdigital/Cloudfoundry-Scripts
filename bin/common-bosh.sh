...
BOSH_CLOUD_MANIFEST_PREFIX="${4:-${BOSH_FULL_MANIFEST_PREFIX:-$CPI_TYPE-CloudConfig}}"
BOSH_LITE_MANIFEST_NAME="${5:-${BOSH_LITE_MANIFEST_NAME:-Bosh-Template-$CPI_TYPE}}"
...
#
BOSH_LITE_MANIFEST_FILE="$MANIFESTS_DIR/Bosh-Lite-Manifests/$BOSH_LITE_MANIFEST_NAME-$CPI_TYPE.yml"
