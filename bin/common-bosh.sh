...
[ -n "$PRIVATE_BOSH_LITE_OPS_FILE_NAME" -a -f "$OPS_FILES_CONFIG_DIR/$PRIVATE_BOSH_LITE_OPS_FILE_NAME.yml" ] && PRIVATE_BOSH_LITE_OPS_FILE="$OPS_FILES_CONFIG_DIR/$PRIVATE_BOSH_LITE_OPS_FILE_NAME.yml"
[ -n "$PRIVATE_BOSH_FULL_OPS_FILE_NAME" -a -f "$OPS_FILES_CONFIG_DIR/$PRIVATE_BOSH_FULL_OPS_FILE_NAME.yml" ] && PRIVATE_BOSH_FULL_OPS_FILE="$OPS_FILES_CONFIG_DIR/$PRIVATE_BOSH_FULL_OPS_FILE_NAME.yml"
