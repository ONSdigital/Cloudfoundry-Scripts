...
[
	...
	{ "ParameterKey": "ExternalCidr1", "ParameterValue": "${EXTERNAL_CIDR1:-127.0.0.0/8}" },
	{ "ParameterKey": "ExternalCidr2", "ParameterValue": "${EXTERNAL_CIDR2:-127.0.0.0/8}" },
	{ "ParameterKey": "ExternalCidr3", "ParameterValue": "${EXTERNAL_CIDR3:-127.0.0.0/8}" },
	{ "ParameterKey": "ExternalCidr4", "ParameterValue": "${EXTERNAL_CIDR4:-127.0.0.0/8}" },
	{ "ParameterKey": "ExternalCidr5", "ParameterValue": "${EXTERNAL_CIDR5:-127.0.0.0/8}" },
	{ "ParameterKey": "ExternalCidr6", "ParameterValue": "${EXTERNAL_CIDR6:-127.0.0.0/8}" },
	{ "ParameterKey": "ExternalCidr7", "ParameterValue": "${EXTERNAL_CIDR6:-127.0.0.0/8}" },
	{ "ParameterKey": "ExternalCidr8", "ParameterValue": "${EXTERNAL_CIDR6:-127.0.0.0/8}" }
]
EOF
