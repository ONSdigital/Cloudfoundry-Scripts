...
if [ -n "$REAL_RHEL" ]; then
	...
	install_packages rh-python34-python rh-python34-python-setuptools rh-python34-python-pip rh-python34-python-devel libyaml-devel bzip2
else
	install_packages python34 python34-setuptools python34-pip python34-devel libyaml-devel bzip2
fi
