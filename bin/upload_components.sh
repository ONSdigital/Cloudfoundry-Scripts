...
RELEASE_POSTGRESQL_DATABASES_URL="${RELEASE_POSTGRESQL_DATABASES_URL:-https://github.com/ONSdigital/postgresql-databases-release}"
#RELEASE_CF_RABBITMQ_BROKER_URL="${RELEASE_CF_RABBITMQ_URL:-https://bosh.io/d/github.com/pivotal-cf/cf-rabbitmq-broker}"

BOSH_UPLOADS='BOSH_STEMCELL RELEASE_CF RELEASE_DIEGO RELEASE_GARDEN_RUNC RELEASE_CFLINUXFS2_ROOTFS RELEASE_CF_RABBITMQ RELEASE_POSTGRESQL_DATABASES'
